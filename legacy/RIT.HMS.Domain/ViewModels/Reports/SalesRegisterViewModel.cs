...
namespace RIT.HMS.Domain.ViewModels.Reports
{
    public class SalesRegisterViewModel
    {
        ...
        public decimal GPPres { get; set; }
        public string DATEPART { get; set; }
        public string DiscRem { get; set; }

        public decimal AverageCost { get; set; } //--- Added By Nipuna Francisku #2619
        public decimal AverageCostAmount { get; set; } //--- Added By Nipuna Francisku #2619
        public decimal AverageGP { get; set; } //--- Added By Nipuna Francisku #2619
        public decimal AverageGPPres { get; set; } //--- Added By Nipuna Francisku #2619
