...
namespace RIT.HMS.Domain
{
    public class TransactionDet
    {
        ...
        {
            SalesIN = new List<TransactionDet>();
            SalesOut = new List<TransactionDet>();
        }
        public int   TransactionDetID  { get; set; }
        [DefaultValue(0)]

        [NotMapped]
        public List<TransactionDet> SalesIN { get; set; }
        [NotMapped]
        public List<TransactionDet> SalesOut { get; set; }
        ...
        [DefaultValue(0)]
        public Int32 ServingUnitId { get; set; }
