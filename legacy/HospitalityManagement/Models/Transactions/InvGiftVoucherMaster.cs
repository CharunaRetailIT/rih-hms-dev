...
namespace HospitalityManagement.Models.Transactions
{
    public class InvGiftVoucherMaster : BaseEntity
    {
        ...
        public List<InvGiftVoucherBookCode> GVBookcodes { get; set; }

        public InvGiftVoucherMaster()
        {
            GVGroups = new List<InvGiftVoucherGroup>();
            GVBookcodes = new List<InvGiftVoucherBookCode>();
