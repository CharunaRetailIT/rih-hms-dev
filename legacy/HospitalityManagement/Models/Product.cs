...
namespace HospitalityManagement.Models
{
    public class Product : BaseEntity
    {
        public Product()
        {
            ...
            KitchenPrinters_Modl = new List<KitchenPrinters>();
        ...
        [NotMapped]
        public List<KitchenPrinters> KitchenPrinters_Modl { get; set; }

        [NotMapped]
        public List<KitchenPrinters> KitchenPrinters_Modl1 { get; set; }
